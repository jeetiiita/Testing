...
public class SupportConstants extends com.clicktable.util.Constants {
	...
	//Delay Queue for SMS Delivery
	public static final String DELAY_QUEUE_DEQUE_TIME = "delayQueue.dequeTime";
	public static final String DELAY_QUEUE_DELAY_TIME = "delayQueue.delayTime";
	public static final String DELAY_QUEUE_MAX_DEQUE_SIZE = "delayQueue.maxDequeSize";
    ...
    public static final String INVOICE_FOLDER = "invoice-pdf";
    ...
    public static final String FIN_MONTH = "finMonth";

    public static final String FIN_YEAR = "finYear";

    public static final String AGGRGEGATE_TAX = "AggregateTax";

    public static final String PLAN_TAX = "PlanAndTax";
